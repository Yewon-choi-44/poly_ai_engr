...
public class jdbc0609_connection4 extends JFrame{
	...
	public jdbc0609_connection4() {
		...
		btn2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					Connection con2 = DBconnection();
					Statement stmt = con2.createStatement();
					stmt.executeUpdate("delete from sample where username='" + tf_name.getText() + "'");
				} catch (SQLException e1) {
//					System.out.println("삭제불가");
	...
	public static Connection DBconnection() {
		try {
				conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/madang", "root", "#mysql123");
