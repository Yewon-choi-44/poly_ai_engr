...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Sequential(
            nn.Linear(in_features=240*240*32, out_features=960, bias=True),
            nn.ReLU(),
            nn.Linear(in_features=960, out_features=480, bias=True),
            nn.ReLU(),
            nn.Linear(in_features=480, out_features=240, bias=True),
            nn.ReLU(),
            nn.Linear(in_features=240, out_features=2, bias=True)
            )
