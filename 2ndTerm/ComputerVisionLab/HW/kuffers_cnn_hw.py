...
# def create_synthetic_capacitor_dataset(base_dir='kuffers_capacitor', num_samples=30):
...
#             """ 
#             커패시터 바디
#             color = (R=180, G=180, B= 190) 색상 배경, 960*960 크기 RGB 이미지 생성
#             """
#             img = Image.new('RGB', (960, 960), color=(180, 180, 190))
#             draw = ImageDraw.Draw(img)



#             # 커패시터 윤곽선 (정상적인 형태)-----------------------
#             draw.circle( (480,480),450.0)

#             # draw.rectangle([40, 60, 184, 164], fill=(100, 100, 110), outline=(50, 50, 50), width=3)

#             # 불량(NG) 샘플에 부서짐(Broken), 누락(Missing) 패턴 추가
#             if label == "NG":
#                 x1 = np.random.randint(30, 920)
#                 y1 = np.random.randint(30, 920)
